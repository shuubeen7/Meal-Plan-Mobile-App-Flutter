...
class AdminListOrders extends StatefulWidget {
  final String uid;
  const AdminListOrders({Key? key, required this.uid}) : super(key: key);

  @override
  State<AdminListOrders> createState() => _AdminListOrdersState();
}

class _AdminListOrdersState extends State<AdminListOrders> {
