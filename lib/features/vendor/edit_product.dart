...
class _EditProductState extends State<EditProduct> {
  ...
  void initState() {
    ...
    descController.text = widget.product.productDesc;
                    ...
                    ClipRRect(
                        ...
                        child: image != null
                          ...
                          fit: BoxFit.cover,
                            ...
                            : widget.product.productImage.isEmpty ? Image.network(
  ...
  void updateProduct() async {
    ...
    if (image != null) {
      imageUrl = await uploadImage(image!, vendorId,widget.product.productId);
    } else {
