...
class ListRejectedOrders extends StatefulWidget {
  const ListRejectedOrders({Key? key}) : super(key: key);

  @override
  State<ListRejectedOrders> createState() => _ListRejectedOrdersState();
}

class _ListRejectedOrdersState extends State<ListRejectedOrders> {
          ...
          if (!snapshot.hasData) {
            ...
            if (snapshot.data?.snapshot.value == null) {
              ...
              values.forEach((key, value) {
                ...
                if (item.isConfirmed != null && item.isConfirmed! == false) {
                  orders.add(item);
                }
              });
            }
